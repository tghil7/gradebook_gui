...
def createGraph(file):
    ...
    for val,col in zip(PieV,colV):    
        ...
        st = st + val*3.6
    canvas.create_rectangle((550, 50), (675, 175))
    #Additional the color description and triangles.
    canvas.create_rectangle((560, 60), (570, 70), fill='Red')
    label = canvas.create_text(620, 65, text="Percentage of A" )
    canvas.create_rectangle((560, 80), (570, 90), fill='Aqua')
    label = canvas.create_text(620, 85, text="Percentage of B" )
    canvas.create_rectangle((560, 100), (570, 110), fill='Green')
    label = canvas.create_text(620, 105, text="Percentage of C" )
    canvas.create_rectangle((560, 120), (570, 130), fill='Blue')
    label = canvas.create_text(620, 125, text="Percentage of D" )
    canvas.create_rectangle((560, 140), (570, 150), fill='Yellow')
    label = canvas.create_text(620, 145, text="Percentage of F" )
